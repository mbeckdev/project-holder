...
const projectList = [
  ...
  },
  {
    ...
    codeLink: 'https://github.com/thinkswell/javascript-mini-projects/tree/master/AnnoyingButtonGame/MBECKDEV'
  },
  {
    name: 'Tiny CRUD Class Components',
    imgURL: imgTinyCrudClassComponents,
    description: 'A tiny CRUD task list - code to help remember state and props with class components in React. CRUD stands for Create, Read, Update, and Delete',
    tech: ['react', 'html', 'css', ],
  ...
  },
  {
    ...
    description: "A tiny CRUD task list - code to help remember Hooks with functional components in React. CRUD stands for Create, Read, Update, and Delete",
    tech: ['react', 'html', 'css', ],
  ...
  },
  {
    ...
    imgURL: imgMnemonic,
    description: "Need help remembering a few letters? Enter your letters and click the button. Bam! A sentence appears with every word starting with one of your letters. If you remember that sentence, you can remember your word easier.",
